...
import com.mehboob.passiveincome.ui.models.Accounts;
...
public class DepositActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       switch (account){
           ...
           case "Bank":
               binding.lineJazz.setVisibility(View.GONE);
               binding.lineEasy.setVisibility(View.GONE);
               break;
           case "Jazz":
               binding.lineEasy.setVisibility(View.GONE);
               binding.lineBank.setVisibility(View.GONE);
               break;
           case "Easy":
               binding.lineBank.setVisibility(View.GONE);
               binding.lineJazz.setVisibility(View.GONE);
        ...
        accountRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    binding.txtBankAccountName.setText(accounts.getBankAccountName());
                    binding.txtBankAccountNumber.setText(accounts.getBankAccountNumber());
                    binding.txtJazzCashAccountName.setText(accounts.getJazzAccountName());
